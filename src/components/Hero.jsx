...
<svg className="decor-line top-left" viewBox="0 0 200 200">
  <path
    d="M0,100 C50,50 150,150 200,100"
    stroke="#90a4ae"
    strokeWidth="2"
    fill="transparent"
    strokeDasharray="6 6"
...
<svg className="decor-line top-right" viewBox="0 0 200 200">
  <path
    d="M0,50 C70,20 130,180 200,150"
    stroke="#b0bec5"
    strokeWidth="2"
    fill="transparent"
  />
...
<svg className="decor-line bottom-left" viewBox="0 0 200 200">
  <path
    d="M0,150 C60,180 140,20 200,50"
    stroke="#cfd8dc"
    strokeWidth="3"
    fill="transparent"
    strokeDasharray="4 8"
      ...
      <div className="hero-content">
        ...
        >
          ...
          <p>
            ...
            <b>React</b>, <b>JavaScript</b>, and <b>CSS</b>.
          </p>
          ...
          <div className="hero-buttons">
            ...
            <motion.button whileHover={{ scale: 1.1 }} className="btn secondary">
              📄 Download Resume
            </motion.button>
          </div>
        </motion.div>
